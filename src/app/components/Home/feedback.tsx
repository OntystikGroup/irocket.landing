...
export const Feedback = () => {
  return (
    <div className="mt-[6em] p-10 bg-gradient-to-r from-slate-100 to-primary-light" id="feedback">
      <div className="pt-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 pt-10 pb-20 md:px-20">
        {reviews.map((review) => (
          <div key={review.id} className="flex gap-2 bg-white p-6 rounded-lg shadow-lg w-full">
            <Avatar
              src={review.avatar}
