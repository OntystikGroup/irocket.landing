...
const HowItWorks = () => {
  return (
    <div className="grid gap-10 px-4 py-10 lg:grid-cols-2 lg:px-10">
      <div className="flex flex-col justify-center space-y-6">
        <h3 className="text-3xl sm:text-4xl font-bold mb-6 text-center lg:text-left">Как это работает:</h3>
        <Card className="p-4">
          <CardBody>
            <h4 className="text-lg sm:text-xl font-semibold mb-2">1. Увеличение отзывов и рейтингов:</h4>
            <p className='text-sm'>
        ...
        <Card className="p-4">
          <CardBody>
            <h4 className="text-lg sm:text-xl font-semibold mb-2">2. Автоматические рассылки:</h4>
            <p className='text-sm'>
        ...
        <Card className="p-4">
          <CardBody>
            <h4 className="text-lg sm:text-xl font-semibold mb-2">3. Повышение лояльности клиентов:</h4>
            <p className='text-sm'>
      ...
      <div className="flex justify-center items-center lg:mt-0">
        <Image src={NotificationsImage} height={500} width={500} alt="How it works" />
      </div>
    </div>
  );
};
