...
const PriceManagement = () => {
  const rows = [
    ...
    },
    {
      ...
      automated: "Система полностью берет под контроль цены на 250 товаров одновременно",
    },
    {
      manual: "Необходимость ручного обновления цен при изменении условий рынка",
      automated: "Демпинг бот оперативно обновляет цены в зависимости от изменений на рынке каждые 3-4 минуты",
    },
  ];
